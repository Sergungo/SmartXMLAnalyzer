package ua.com.agileengine.golenko.main.java;
...
public class SmartXmlAnalyzer {
    ...
    public static void main(String[] args) throws IOException {
        ...
        // add all possible elements to container from other file which contains
        // attributes target element
    ...
    private static String getPath(Element element) {
        ...
        parents.add(element);
        return parents.stream().map(el -> el.nodeName() + "[" + el.elementSiblingIndex() + "]").collect(Collectors.joining(" > "));
    }
}